...
public class GamePanel extends JPanel {
	...
	protected void paintComponent(Graphics g) {
		...
		fillCell(g2, 3, 4, width, height, true);
		fillCell(g2, 2, 1, width, height, true);
		fillCell(g2, 3, 4, width, height, false);
	}
	
	private void fillCell(Graphics2D g2, int row, int col, int width, int height, boolean status) {
