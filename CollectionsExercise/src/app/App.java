 ...
 * Implement a rota.
 * 
 * We have a list of nine people with the following skills as follows:
 * 
 * Oliver	programming 
 * Jake	engineering 
 * Amelia	reception management programming 
 * Noah	programming engineering 
 * James	management reception engineering 
 * Margaret	engineering 
 * Emma	management programming engineering 
 * Jack	engineering reception  
 * Mary	engineering reception electronics 
 * 
 ...
 * 
 * Create a Rota class that for any given week, will tell us which three people are working that day.
 * 
 ...
 * 
 * Rota has a method add(String person, String... skill) that adds people and their skills.
 * 
 * Tips:
 * 
...
// @formatter:off
/*
 String[][] peopleSkills = { { "Oliver", "programming", "electronics" },
...
/*
 * Auto-generate list of people and skills. Don't use this in your solution; use the 2D array that I provide.
 * 
 * Bonus questions: 
 * What drawbacks are there to your algorithm? Can you think of ways to improve the situation?
